...
urlpatterns = [
    ...
    path('favoritetruckmodel/<int:pk>/truckmodel/<int:truck_model_pk>/', views.FavoriteTrucksListTruckModelAssoc.as_view(), name="favorite_trucks_list_truck_model_assoc"),
]